...
public class UserProfileActivityy extends AppCompatActivity {
    ...
    public static Intent createIntent(
        ...
        return startIntent.setClass(context, UserProfileActivityy.class)
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            LoginActivity.start(UserProfileActivityy.this);
